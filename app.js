const STARTER_WORDS = [
  ...
  ["feasible", "adj. 可行的；行得通的；可能的", "It is not feasible to finish the whole report in one night."],
  ["estimate", "v. 估计；估算；评价；n. 估计；估价；预算", "Engineers estimate that the bridge will take two years to build."],
  ["ultimate", "adj. 最终的；根本的；最大的；n. 极点；极致", "Their ultimate goal is to cut the cost of the whole process."],
  ["mood", "n. 情绪；心情；气氛；（动词的）语气", "The mood in the office improved after the good news."],
  ["circulate", "v. 流通；传播；循环；分发", "Rumors about the merger circulated quickly among the staff."],
  ["ventilate", "v. 使通风；使空气流通；公开讨论", "The workshop is ventilated by two large windows."],
  ["accumulate", "v. 积累；积聚；堆积", "Dust had accumulated on the shelves for years."],
  ["algorithm", "n. 算法；运算法则", "The new algorithm sorts the data far more quickly."],
  ["sow", "v. 播种；种下；散布；煽动", "Farmers sow wheat in early autumn."],
  ["reap", "v. 收获；收割；获得回报", "The firm is now reaping the benefits of its early investment."],
  ["ripe", "adj. 成熟的；熟透的；时机成熟的", "The apples were not ripe enough to pick."],
  ["irritable", "adj. 易怒的；暴躁的；易受刺激的", "He gets irritable when he has not slept well."],
  ["yield", "n. 产量；收益；v. 出产；屈服；让路", "The farm's yield doubled after the new irrigation system was installed."],
  ["overwhelm", "v. 压倒；淹没；使不知所措；击败", "The small clinic was overwhelmed by the number of patients."],
  ["overthrow", "v. 推翻；打倒；n. 推翻；垮台", "The people rose up to overthrow the old regime."],
  ["overturn", "v. 推翻；使翻倒；撤销", "The court overturned the earlier ruling."],
  ["swing", "v. 摇摆；挥动；转向；n. 摆动；秋千", "The door swung open in the wind."],
  ["sway", "v. 摇摆；影响；使动摇；n. 摇摆；支配", "Public opinion swayed the committee's decision."],
  ["swell", "v. 膨胀；肿胀；增加；n. 膨胀；涌浪", "His ankle began to swell after the fall."],
  ["swear", "v. 发誓；宣誓；咒骂", "She swore that she had never seen the letter."],
  ["scream", "v. 尖叫；大声喊；n. 尖叫声", "The child screamed when the lights went out."],
  ["scold", "v. 责骂；训斥；n. 责骂", "The coach scolded the players for arriving late."],
  ["scorn", "n. 鄙视；轻蔑；v. 鄙视；不屑于", "He poured scorn on the idea before he had even read it."],
  ["scare", "v. 使害怕；使惊恐；n. 惊恐；恐慌", "The sudden noise scared the horses."],
  ["sprout", "v. 发芽；生长；涌现；n. 芽；苗", "The seeds sprouted within a week."],
  ["spite", "n. 恶意；怨恨；v. 刁难；使恼怒", "They went ahead in spite of the warnings."],
  ["spray", "v. 喷洒；喷雾；n. 喷雾；喷雾器；水花", "The gardener sprayed the roses against insects."],
  ["pray", "v. 祈祷；恳求", "They prayed for the safe return of the crew."],
  ["prey", "n. 猎物；受害者；v. 捕食；折磨", "Owls hunt their prey at night."],
  ["predator", "n. 捕食者；掠夺者；天敌", "Wolves are the main predator in this forest."],
  ["array", "n. 排列；一系列；数组；v. 排列；部署", "The shop offers a wide array of tools."],
  ["deteriorate", "v. 恶化；退化；变坏", "His health deteriorated rapidly over the winter."],
  ["scope", "n. 范围；视野；机会；v. 仔细研究", "The scope of the study was wider than expected."],
  ["realm", "n. 领域；范围；王国", "This question belongs to the realm of philosophy."],
  ["vibrate", "v. 振动；颤动；使振动", "The whole floor vibrated when the train passed."],
  ["violate", "v. 违反；侵犯；亵渎", "The company violated the terms of the contract."],
  ["tailor", "n. 裁缝；v. 定制；使适应", "The course is tailored to the needs of working students."],
  ["entail", "v. 需要；使承担；包含", "Running a shop entails long hours and little rest."],
  ["commerce", "n. 商业；贸易；交流", "Online commerce has grown faster than any other sector."],
  ["stall", "n. 货摊；摊位；v. 使停顿；拖延", "The negotiations stalled over the question of pay."],
  ["commodity", "n. 商品；日用品；有用之物", "Oil is the most heavily traded commodity in the world."],
  ["merchant", "n. 商人；批发商；adj. 商业的；商船的", "The merchant shipped wool to the mainland."],
  ["merchandise", "n. 商品；货物；v. 推销", "The store displays its merchandise near the entrance."],
  ["duplicate", "v. 复制；重复；n. 复制品；adj. 复制的", "Please do not duplicate this form."],
  ["triple", "adj. 三倍的；三重的；v. 使增至三倍", "Their profits tripled in three years."],
  ["trivial", "adj. 琐碎的；微不足道的", "Do not waste time on trivial details."],
  ["companion", "n. 同伴；伴侣；手册", "The dog was his only companion on the long walk."],
  ["accompany", "v. 陪伴；伴随；为……伴奏", "Heavy rain accompanied the strong wind."],
  ["venture", "n. 冒险；企业；v. 冒险；敢于", "The new venture failed within a year."],
  ["gamble", "v. 赌博；冒风险；n. 赌博；冒险", "They gambled everything on a single product."],
  ["hazard", "n. 危险；危害；v. 冒险；使遭受危险", "Smoking is a serious health hazard."],
  ["stake", "n. 赌注；股份；利害关系；v. 以……打赌", "The company has a large stake in the project."],
  ["trap", "n. 陷阱；圈套；v. 诱捕；使陷入困境", "The mice were caught in a simple trap."],
  ["strap", "n. 带子；皮带；v. 用带捆扎", "He strapped the box onto the back of his bike."],
  ["appropriate", "adj. 适当的；恰当的；v. 挪用；占用", "Wear appropriate clothes for the interview."],
  ["property", "n. 财产；房产；性质；属性", "The family sold its property in the city."],
  ["estate", "n. 房地产；庄园；遗产", "He left his whole estate to the local school."],
  ["asset", "n. 资产；财产；有价值的人或物", "Patience is a great asset in this job."],
  ["settle", "v. 解决；安顿；定居；平静下来", "The two sides settled the dispute out of court."],
  ["dwell", "v. 居住；栖身；细想", "A few families still dwell on the island."],
  ["dwelling", "n. 住宅；住所", "The old dwelling had no running water."],
  ["tackle", "v. 处理；应付；擒抱；n. 用具；阻截", "The government must tackle the housing shortage."],
  ["cope", "v. 应对；处理；对付", "She coped well with the extra workload."],
  ["dissolve", "v. 溶解；解散；消失", "Sugar dissolves quickly in hot water."],
  ["mature", "adj. 成熟的；熟透的；v. 成熟；到期", "She is very mature for her age."],
  ["moral", "adj. 道德的；有道德的；n. 道德；寓意", "The story carries a clear moral lesson."],
  ["mortal", "adj. 凡人的；致死的；n. 凡人", "All human beings are mortal."],
  ["ethic", "n. 道德准则；伦理；职业道德", "A strong work ethic is valued here."],
  ["addict", "n. 上瘾者；瘾君子；v. 使上瘾；使沉溺", "He became addicted to gambling."],
  ["contradict", "v. 反驳；与……矛盾；否认", "The two reports contradict each other."],
  ["extinguish", "v. 扑灭；熄灭；使消失", "Firefighters extinguished the blaze in an hour."],
  ["distinguish", "v. 区分；辨别；使杰出", "It is hard to distinguish the twins."],
  ["instinct", "n. 本能；直觉；天性", "Birds build nests by instinct."],
  ["sting", "v. 刺；蜇；刺痛；n. 刺；蜇伤", "A bee stung him on the arm."],
  ["pierce", "v. 刺穿；穿透；深深影响", "The arrow pierced the wooden board."],
  ["string", "n. 细绳；一串；弦；v. 串起", "She tied the parcel with string."],
  ["rope", "n. 绳子；绳索；v. 用绳捆", "They pulled the boat ashore with a rope."],
  ["invade", "v. 入侵；侵略；侵犯；侵扰", "Tourists invade the town every summer."],
  ["evade", "v. 逃避；躲开；回避", "He evaded the question by changing the subject."],
  ["intrinsic", "adj. 固有的；内在的；本质的", "Curiosity is intrinsic to good research."],
  ["extrinsic", "adj. 外在的；外来的；非固有的", "Money is an extrinsic reward."],
  ["external", "adj. 外部的；外面的；外来的；n. 外部", "The building needs external repairs."],
  ["interior", "n. 内部；内地；adj. 内部的", "The interior of the house is surprisingly bright."],
  ["exterior", "n. 外部；外表；adj. 外部的", "The exterior of the car was badly scratched."],
  ["vacation", "n. 假期；休假；v. 度假", "They spent their vacation by the sea."],
  ["vocation", "n. 职业；使命；天职", "Teaching was her vocation, not just a job."],
  ["excursion", "n. 短途旅行；远足；偏离", "The class went on a day excursion to the museum."],
  ["diagnose", "v. 诊断；判断；查明原因", "The doctor diagnosed a mild infection."],
  ["clinic", "n. 诊所；门诊部；会诊", "She works at a small clinic near the station."],
  ["acute", "adj. 急性的；敏锐的；严重的；尖锐的", "He was taken to hospital with acute pain."],
  ["terminal", "n. 终点站；终端；adj. 末期的；终点的", "The bus stopped at the airport terminal."],
  ["remedy", "n. 补救办法；治疗；v. 补救；纠正", "There is no easy remedy for this problem."],
  ["heal", "v. 治愈；愈合；使和解", "The wound healed within two weeks."],
  ["recovery", "n. 康复；恢复；复苏", "The economy is showing signs of recovery."],
  ["revive", "v. 复苏；使复活；重新流行", "The old custom has been revived in recent years."],
  ["grip", "v. 紧握；抓紧；吸引；n. 紧握；控制", "She gripped the rail as the bus turned."],
  ["stain", "n. 污渍；污点；v. 玷污；染色", "Coffee left a stain on the tablecloth."],
  ["restrain", "v. 抑制；约束；阻止", "He could not restrain his laughter."],
  ["restraint", "n. 克制；约束；限制", "The teacher showed remarkable restraint."],
  ["hinder", "v. 阻碍；妨碍", "Heavy snow hindered the rescue work."],
  ["obstruct", "v. 阻碍；堵塞；妨碍", "A fallen tree obstructed the road."],
  ["block", "v. 阻挡；阻塞；n. 街区；大楼；一块", "A parked van blocked the entrance."],
  ["hamper", "v. 妨碍；阻碍；n. 篮筐；有盖大篮子", "Thick fog hampered the search."],
  ["hammer", "n. 锤子；榔头；v. 锤击；反复敲打", "He hammered the nail into the wall."],
  ["mercy", "n. 仁慈；宽容；幸运的事", "The prisoners begged for mercy."],
  ["pathetic", "adj. 可怜的；令人怜惜的；差劲的", "The team gave a pathetic performance."],
  ["atom", "n. 原子；微粒", "An atom consists of a nucleus and electrons."],
  ["electron", "n. 电子", "The electron carries a negative charge."],
  ["contaminate", "v. 污染；弄脏；使不纯", "The river was contaminated by factory waste."],
  ["rear", "v. 抚养；饲养；抬起；n. 后部；adj. 后面的", "They rear cattle on the hillside."],
  ["breed", "v. 繁殖；饲养；引起；n. 品种；种类", "These birds breed once a year."],
  ["foster", "v. 培养；促进；寄养；adj. 收养的", "The programme fosters cooperation between schools."],
  ["flourish", "v. 繁荣；兴旺；茂盛", "Small shops flourished in the old town."],
  ["flour", "n. 面粉；粉；v. 撒粉", "The bread is made from whole wheat flour."],
  ["powder", "n. 粉末；火药；v. 撒粉", "Mix the powder with warm water."],
  ["nurture", "v. 培养；养育；滋养；n. 养育", "Good teachers nurture curiosity."],
  ["nutrient", "n. 营养物；养分；adj. 有营养的", "Green vegetables are rich in nutrients."],
  ["dignity", "n. 尊严；庄严；高贵", "He faced the illness with quiet dignity."],
  ["indignant", "adj. 愤怒的；愤慨的", "She was indignant at the unfair decision."],
  ["vicious", "adj. 恶毒的；凶猛的；残酷的", "The dog gave a vicious growl."],
  ["evil", "adj. 邪恶的；有害的；n. 邪恶；恶事", "He believed that greed was the root of all evil."],
  ["brutal", "adj. 残酷的；野蛮的；直白的", "The film shows the brutal reality of war."],
  ["bruise", "n. 瘀伤；青肿；v. 碰伤；擦伤", "She had a bruise on her knee."],
  ["shrewd", "adj. 精明的；敏锐的；有眼光的", "He is a shrewd judge of character."],
  ["fragment", "n. 碎片；片段；v. 使碎裂", "Fragments of glass lay on the floor."],
  ["fragile", "adj. 脆弱的；易碎的；易受伤害的", "The vase is too fragile to post."],
  ["friction", "n. 摩擦；摩擦力；冲突", "Oil reduces friction between the parts."],
  ["collide", "v. 碰撞；相撞；冲突", "Two cars collided at the junction."],
  ["clash", "v. 冲突；抵触；碰撞；n. 冲突；撞击声", "The two plans clash with each other."],
  ["smash", "v. 猛撞；粉碎；打破；n. 撞击；破碎", "The ball smashed the window."],
  ["harmony", "n. 和谐；协调；和声", "The two communities live in harmony."],
  ["authentic", "adj. 真实的；正宗的；可靠的", "The restaurant serves authentic Sichuan food."],
  ["genuine", "adj. 真正的；真诚的；真品的", "She showed genuine concern for the patients."],
  ["ingenious", "adj. 巧妙的；有独创性的", "He found an ingenious solution to the problem."],
  ["forge", "v. 伪造；锻造；努力争取；n. 锻炉", "Someone forged his signature on the check."],
  ["mortgage", "n. 抵押贷款；按揭；v. 抵押", "They took out a mortgage to buy the apartment."],
  ["vulgar", "adj. 粗俗的；庸俗的；下流的", "The joke was too vulgar for a formal dinner."],
  ["crude", "adj. 粗糙的；天然的；粗鲁的；n. 原油", "The estimate was based on crude figures."],
  ["cognitive", "adj. 认知的；认识的", "The study measures cognitive development in children."],
  ["recognize", "v. 认出；识别；承认；认可", "I did not recognize him with his new glasses."],
  ["identical", "adj. 完全相同的；同一的", "The two copies are identical."],
  ["dentist", "n. 牙医；牙科诊所", "You should see a dentist about that tooth."],
  ["compound", "n. 化合物；复合物；v. 使加重；adj. 复合的", "Water is a simple chemical compound."],
  ["groan", "v. 呻吟；抱怨；n. 呻吟声", "He groaned when he saw the bill."],
  ["gross", "adj. 总的；毛的；粗俗的；严重的；v. 总收入为", "The company reported gross profits of two million."],
  ["moan", "v. 呻吟；抱怨；n. 呻吟声；抱怨", "She moaned about the cold weather."],
  ["mourn", "v. 哀悼；悼念；悲伤", "The whole town mourned the loss of the teacher."],
  ["affluent", "adj. 富裕的；丰富的", "They moved to a more affluent area."],
  ["mischief", "n. 恶作剧；淘气；伤害", "The children were up to mischief again."],
  ["discharge", "v. 排出；释放；解雇；n. 排出物；排放", "The factory discharges water into the river."],
  ["disgust", "n. 厌恶；反感；v. 使厌恶", "He looked at the mess with disgust."],
  ["digest", "v. 消化；理解；n. 摘要；文摘", "It takes hours to digest a heavy meal."],
  ["summon", "v. 召唤；传唤；召集；鼓起", "She summoned the courage to speak."],
  ["abuse", "n. 滥用；虐待；辱骂；v. 滥用；虐待", "The report describes the abuse of power."],
  ["formation", "n. 形成；构成；编队；构造", "The formation of ice takes several hours."],
  ["conform", "v. 遵守；符合；顺应；顺从", "All new buildings must conform to safety rules."],
  ["inform", "v. 通知；告知；检举", "Please inform us of any change of address."],
  ["formulate", "v. 制定；构想；系统阐述", "The team formulated a new strategy."],
  ["firm", "adj. 坚固的；坚定的；严格的；n. 公司；商行", "She gave a firm answer."],
  ["infirm", "adj. 虚弱的；衰老的；不坚固的", "He cares for his infirm mother."],
  ["affirm", "v. 断言；证实；肯定", "The witness affirmed that the statement was true."],
  ["pledge", "n. 誓言；保证；抵押；v. 发誓；保证；抵押", "The government pledged to cut waiting times."],
